...
function sneaker() {
  return (
    ...
    <div className='flex flex-wrap items-center justify-center gap-7 w-full'>
        <div className='bg-[url("/sneaker-splash.png")]  bg-contain bg-center bg-no-repeat  w-11/12 h-48  rounded-t-lg  md:h-96  max-w-3xl '></div>
        <div className='bg-[url("/sneaker-splash-2.png")]  bg-contain bg-center bg-no-repeat  w-11/12 h-48  rounded-t-lg  md:h-96  max-w-3xl '></div>
        
        <div className='bg-[url("/sneaker-splash-3.png")]  bg-contain bg-center bg-no-repeat w-44   rounded-t-lg h-72 lg:h-80 xl:h-96  max-w-3xl '></div>
        <div className='bg-[url("/sneaker-splash-4.png")]  bg-contain bg-center bg-no-repeat  w-44   rounded-t-lg h-72 lg:h-80 xl:h-96  max-w-3xl '></div>
    </div>
