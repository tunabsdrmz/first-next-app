  ...
  return (
    <div className='flex flex-col items-center justify-center w-full h-screen bg-[url("../assets/pexels-adrien-olichon-2387793.jpg")] bg-cover'> 
      ...
      <div className='flex gap-4 mt-4 lg:mt-5'>
          <a href='https://www.linkedin.com/in/tuna-boşdurmaz-2b64b9240/' target={'_blank'}> <Image 
            src={İn}
            width={36}
            height={36}
            ...
            <a href='https://github.com/tunabsdrmz' target={'_blank'}>
            <Image 
            src={github}
            width={36}
            height={36}
           ...
           <a href='mailto:tunabosdurmaz2002@gmail.com' target={'_blank'}><div className='flex items-center justify-center gap-2 mt-4 lg:mt-5 border rounded-md py-2 px-14 bg-[#0a66c287] border-[#0a66c2] hover:bg-[#0e5fb1] xl:animate-pulse cursor-pointer'> 
            <Image 
            src={mail}
            height={30}
            width={25}
