...
function Projects() {
  return (
    <div className='flex flex-col gap-6 items-center justify-around w-full bg-[url("/rotated-bg.jpg")] bg-cover'>
        ...
        <div className='flex flex-col items-center w-4/5 h-52 md:h-96  max-w-lg xl:hover:scale-95 transition-all'>
            <div className='bg-[url("/sneaker-splash.png")] bg-[#ffffff] bg-contain bg-center bg-no-repeat  w-full h-40 rounded-t-lg md:h-80'>
            </div>
        ...
        <div className='flex flex-col items-center w-4/5 h-52 md:h-96  max-w-lg xl:hover:scale-95 transition-all'>
        <div className='bg-[url("/countries-splash.png")] bg-[#f4f4f4] bg-contain bg-center bg-no-repeat  w-full h-40 rounded-t-lg md:h-80'></div>
            <div className='flex w-full h-10 md:h-16 font-league'>
